# Gonçalves Assessoria e Seguros
...
* Apresentação dos serviços da assessoria
* Layout responsivo para dispositivos móveis
* Formulário de contato com redirecionamento para WhatsApp

## 📌 Observações

Este projeto é uma aplicação front-end estática, sem utilização de back-end ou banco de dados. Todas as interações são processadas no lado do cliente.
